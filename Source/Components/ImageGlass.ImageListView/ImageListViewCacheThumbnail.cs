...
namespace ImageGlass.ImageListView
{
    ...
    /// item thumbnails.
    /// </summary>
    internal class ImageListViewCacheThumbnail : ISTAgentQueue, IDisposable{
        ...
        private readonly Dictionary<Guid, CacheItem> thumbCache;
        private Guid processingRendererItem;
        private Guid processingGalleryItem;
        private readonly Dictionary<Guid, bool> editCache;
        private CacheItem rendererItem;
        private CacheItem galleryItem;

        private readonly List<Guid> removedItems;
        ...
        private class CacheRequest
        {
            ...
            /// </summary>
            public bool UseEmbeddedThumbnails { get; private set; }
            /// <summary>
            ...
            public CacheRequest(Guid guid, ImageListView.ImageListViewItemAdaptor adaptor, object key, Size size, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC, RequestType requestType)
            {
                Guid = guid;
                VirtualItemKey = key;
                Adaptor = adaptor;
            ...
            /// </summary>
            public override string ToString() => $"CacheRequest ({VirtualItemKey})";
        }
        ...
        private class CacheItem : IDisposable {
            ...
            /// <param name="autoRotate">AutoRotate property of the owner control.</param>
            /// <param name="useWIC">Whether to use WIC.</param>
            public CacheItem(Guid guid, Size size, Image image, CacheState state, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
            {
                Guid = guid;
                Size = size;
                Image = image;
            ...
            /// </summary>
            ~CacheItem(){
                Debug.Print("Finalizer of {0} called for non-empty cache item.", GetType());
            }
#endif
        }
        #endregion
        ...
        /// </summary>
        public long CacheSize => thumbCache.Count;
        ...
        public ImageListViewCacheThumbnail(IDiskManager diskManager, ImageListView owner) {
        ...
        /// <param name="autoRotate">AutoRotate property of the owner control.</param>
        /// <param name="useWIC">Whether to use WIC.</param>
        public void Add(Guid guid, ImageListView.ImageListViewItemAdaptor adaptor, object key, Size thumbSize, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
        {
            // Already cached?
            CacheItem item;
            if (thumbCache.TryGetValue(guid, out item))
        ...
        /// <param name="autoRotate">AutoRotate property of the owner control.</param>
        /// <param name="useWIC">Whether to use WIC.</param>
        public void Add(Guid guid, ImageListView.ImageListViewItemAdaptor adaptor, object key, Size thumbSize, Image thumb, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
        {
            Contract.Requires(adaptor != null);
            ...
            var extractor = useWIC
                ? (IThumbnailExtractor) new WicThumbnailExtractor(diskManager, useEmbeddedThumbnails, autoRotate)
                : new DefaultThumbnailExtractor(diskManager, useEmbeddedThumbnails, autoRotate);
            extractor
                .FromImage(thumb, thumbSize)
                .Do(() => Debug.WriteLine("thumbnail error!"),
                    thumbnail =>{
                        // Add to cache
                        thumbCache.Add(guid, new CacheItem(guid, thumbSize, thumbnail, CacheState.Cached, useEmbeddedThumbnails, autoRotate, useWIC));
                        ...
                        mImageListView.OnThumbnailCachedInternal(guid, thumbnail, thumbSize, true);
        ...
        /// <param name="autoRotate">AutoRotate property of the owner control.</param>
        /// <param name="useWIC">Whether to use WIC.</param>
        public void AddToGalleryCache(Guid guid, ImageListView.ImageListViewItemAdaptor adaptor, object key, Size thumbSize, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
        {
            // Already cached?
        ...
        /// <param name="autoRotate">AutoRotate property of the owner control.</param>
        /// <param name="useWIC">Whether to use WIC.</param>
        public void AddToRendererCache(Guid guid, ImageListView.ImageListViewItemAdaptor adaptor, object key, Size thumbSize, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
        {
            // Already cached?
        ...
        /// <param name="autoRotate">AutoRotate property of the owner control.</param>
        /// <param name="useWIC">Whether to use WIC.</param>
        public Image GetRendererImage(Guid guid, Size thumbSize, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
        {
            if (rendererItem != null && rendererItem.Guid == guid && rendererItem.Image != null && rendererItem.Size == thumbSize && rendererItem.UseEmbeddedThumbnails == useEmbeddedThumbnails && rendererItem.AutoRotate == autoRotate && rendererItem.UseWIC == useWIC)
        ...
        /// <param name="autoRotate">AutoRotate property of the owner control.</param>
        /// <param name="useWIC">Whether to use WIC.</param>
        public Image GetGalleryImage(Guid guid, Size thumbSize, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
        {
            if (galleryItem != null && galleryItem.Guid == guid && galleryItem.Image != null && galleryItem.Size == thumbSize && galleryItem.UseEmbeddedThumbnails == useEmbeddedThumbnails && galleryItem.AutoRotate == autoRotate && galleryItem.UseWIC == useWIC)
        ...
        public Image GetImage(Guid guid, Size thumbSize, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC, bool clone)
        {
            CacheItem item;
            if (thumbCache.TryGetValue(guid, out item) && item?.Image != null && item.Size == thumbSize && item.UseEmbeddedThumbnails == useEmbeddedThumbnails && item.AutoRotate == autoRotate && item.UseWIC == useWIC)
        ...
        /// <param name="autoRotate">AutoRotate property of the owner control.</param>
        /// <param name="useWIC">Whether to use WIC.</param>
        public CacheState GetCacheState(Guid guid, Size thumbSize, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
        {
            CacheItem item;
        ...
        static string GetKey(Guid guid, Size size, bool useEmbeddedThumbnails, bool autoRotate, bool useWIC)
        {
            ...
            using (var writer = new BinaryWriter(stream)){
                ...
                writer.Write(useEmbeddedThumbnails);
                ...
                result.ForEach(b => sb.Append(b.ToString("x2")));
                return sb.ToString();
            }
        }
        #endregion
        ...
        private void RunWorker(CacheRequest item, int priority) {
            ...
            if (item.RequestType == RequestType.Renderer)
            {
        ...
        void RunItem(CacheRequest request){
            if (!uiFactory.StartNew(() => ShouldProcess(request)).Result)
                return;

            Image thumb = null;
            var diskCacheKey = GetKey(request.Guid, request.Size, request.UseEmbeddedThumbnails, request.AutoRotate, request.UseWIC);
            ...
            if (thumb == null){
                // TODO revise these background workers! DO true async pattern!
                var thumbResult = request
                    .Adaptor
                    .GetThumbnail(request.VirtualItemKey, request.Size, request.UseEmbeddedThumbnails, request.AutoRotate, request.UseWIC)
                    .Result;
                thumb = thumbResult.GetOrElse(() => null);
                // Save to disk cache
                if (thumb != null)
                    using (var stream = new MemoryStream()){
...
//                mImageListView.OnCacheErrorInternal(result.Guid, e.Error, CacheThread.Thumbnail);
        ...
        bool ShouldProcess(CacheRequest request){
            ...
            var canProcess = !editCache.ContainsKey(request.Guid);
