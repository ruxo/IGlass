...
namespace ImageGlass.ImageListView {
    ...
    public partial class ImageListView : Control
    {
        ...
        private bool mDefaultImageChanged;
        private bool mErrorImageChanged;
        private bool mRatingImageChanged;
        private bool mEmptyRatingImageChanged;
        // Properties
        ...
        private bool mUseEmbeddedThumbnails;
        ...
        Lazy<IDiskManager> diskManager = new Lazy<IDiskManager>(() => new DiskManager(), LazyThreadSafetyMode.PublicationOnly);
        /// <summary>
        /// I/O manager for this control
        /// </summary>
        [Browsable(false)]
        public IDiskManager DiskManager{
            get { return diskManager.Value; }
            set{
                Contract.Requires(value != null);
                diskManager = new Lazy<IDiskManager>(() => value, LazyThreadSafetyMode.None);
            }
        }
        /// <summary>
        ...
        /// </summary>
        [Category("Behavior"), Description("Gets or sets the embedded thumbnails extraction behavior."), DefaultValue(typeof(bool), "true")]
        public bool UseEmbeddedThumbnails
        {
        ...
        public ImageListView()
        {
            ...
            // Cache nabagers
            defaultAdaptor = new ImageListViewItemAdaptors.FileSystemAdaptor(DiskManager);
            thumbnailCache = new ImageListViewCacheThumbnail(DiskManager, this);
        ...
        {
            // TODO major main thread bottleneck!
            Refresh(false, false);
        }
        /// <summary>
