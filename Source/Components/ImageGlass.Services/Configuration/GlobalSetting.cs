...
namespace ImageGlass.Services.Configuration
{
    ...
    {
        static string _facebookAccessToken = "";
        static bool _isForcedActive = true;
        static bool _isRecursive = false;
        static string _supportedDefaultExtensions = "*.jpg;*.jpe;*.jfif;*.jpeg;*.png;" +
                                             "*.gif;*.ico;*.bmp;*.dib;*.tif;*.tiff;" +
                                             "*.exif;*.wmf;*.emf;";
        static string _supportedExtraExtensions = "*.hdr;*.exr;*.tga;*.psd;*.svg;";
        static string _contextMenuExtensions = "";
        static bool _isPlaySlideShow = false;
        static bool _isShowThumbnail = false;
        static bool _isImageError = false;
        static int _zoomLockValue = 100;
        static ZoomOptimizationValue _zoomOptimizationMethod = ZoomOptimizationValue.Auto;
        static bool _isWelcomePicture = true;
        static Color _backgroundColor = Color.White;
        static bool _isShowToolBar = true;
        static bool _isLoopBackSlideShow = false;
        static bool _isPressESCToQuit = true;
        static int _thumbnailDimension = 48;
        static StringCollection _stringClipboard = new StringCollection();
        static bool _isAllowMultiInstances = true;
        static bool _isShowCheckedBackground = false;
        static bool _isTempMemoryData = false;


        static Library.Language _langPack = new Library.Language();
        ...
        /// </summary>
        public static bool IsImageBoosterBack { get; set; }
        ...
        public static ImageOrderBy LoadImageOrderConfig() {
            return GetConfig("ImageLoadingOrder", "0")
                .ParseInt32()
                .Get(() => ImageOrderBy.Name,
                     i =>{
                         switch (i){
                             case 1: return ImageOrderBy.Length;
                             case 2: return ImageOrderBy.CreationTime;
                             case 3: return ImageOrderBy.LastAccessTime;
                             case 4: return ImageOrderBy.LastWriteTime;
                             case 5: return ImageOrderBy.Extension;
                             case 6: return ImageOrderBy.Random;
                             default: return ImageOrderBy.Name;
                         }
                     });
        }
        ...
        public static string GetConfig(string key, string defaultValue){
            ...
            return GetConfig(key).Map(o => o.ToString()).Get(Prelude.Constant(defaultValue), Prelude.Identity);
        }
        ...
        /// <param name="key">Configuration key</param>
        /// <returns></returns>
        public static Option<object> GetConfig(string key){
            Contract.Requires(!string.IsNullOrEmpty(key));
            const string hkey = @"HKEY_CURRENT_USER\Software\PhapSoftware\ImageGlass\";
            return Option<object>.From(() => Registry.GetValue(hkey, key, null));
        }
